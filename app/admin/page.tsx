...
export default async function DashboardPage() {
  ...
  return <div className="stack-lg">
    ...
    {!instalacaoPronta&&<section className="notice notice-error split"><div><strong>Instalação incompleta</strong><p className="small">Conclua identidade, telefone, serviços e expediente antes de divulgar o agendamento.</p></div><Link className="btn" href="/admin/configuracoes">Concluir configuração</Link></section>}
